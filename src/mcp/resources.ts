...
export const SKILL_NAME = "ultraindex";
...
// them:
//
//   <payload>/scripts/ultraindex.mjs  → <payload>/SKILL.md              (installed skill)
//   <repo>/scripts/ultraindex.mjs     → <repo>/skills/ultraindex/SKILL.md (repo-root bundle)
//   <repo>/src/mcp/resources.ts     → <repo>/skills/ultraindex/SKILL.md (source tree, tests)
//
