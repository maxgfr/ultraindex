...
const VALUE_FLAGS = new Set(["repo", "out", "include", "exclude", "max-bytes", "max-files", "k", "depth", "module", "answer", "q", "question", "apply", "max-verify", "phase"]);
const BOOL_FLAGS = new Set(["json", "no-mermaid", "no-cache", "quiet", "force", "semantic", "eco", "list"]);
