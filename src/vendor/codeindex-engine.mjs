...
var WORKER_TIMEOUT_MS, DEFAULT_MIN_PARALLEL_JOBS, BATCHES_PER_WORKER, MIN_BATCH_JOBS;
var init_pool = __esm({
  "src/pool.ts"() {
    "use strict";
    init_hash();
...
var LspTimeout, LspIncomingCallsError, DEFAULT_TIMEOUT, DEFAULT_STARTUP_TIMEOUT;
